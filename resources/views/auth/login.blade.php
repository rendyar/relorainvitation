                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Meinvitation</span>
                            </a>
                        </div>

                        <h4 class="mb-2">Welcome to Meinvitation! 👋</h4>
                        <p class="mb-4">Please sign-in to your account</p>

                        <form id="formAuthentication" action="{{ route('auth.login') }}" class="mb-3" method="POST">
                            @csrf
                            @if ($errors->any())
